 ...
 *
 * @param trips the list of [VehicleTrip] objects to inspect, in chronological order (ordered ascending by the
 * `startTime`).
 * @return a list of [CabinVehicleTrip]s, each containing a to-cabin trip and its corresponding return (if any).
 */
fun findCabinVehicleTrips(trips: List<VehicleTrip>): List<VehicleTrip> {
...
/**
 * Finds the first pair of [VehicleTrip]s representing a trip to the cabin (and an optional corresponding return trip).
 *
 ...
 *
 * This function returns the index and the constructed [VehicleTrip] representing the journey from home to the cabin.
 ...
 *
 * @param trips the list of [VehicleTrip]s to inspect, chronologically ordered (ordered ascending by the `startTime`).
 ...
 *
 * This function returns the index and the constructed [VehicleTrip] representing the journey from the cabin to home.
 ...
 * finding the appropriate start-from-cabin trip and including any intermediate trips with city changes as extra stops.
 ...
 */
private fun findCityChangingTripsBetween(trips: List<VehicleTrip>, fromIndex: Int, toIndex: Int): List<VehicleTrip> =
 ...
 * @param trips A list of [VehicleTrip] objects whose end city names will be included, in order, after [fromCityName].
