...
class VehicleTripServiceTest :
    StringSpec({
        ...
        "From and to dates should be formatted to norwegian format in request" {
        ...
        "Request should be serialized to valid JSON and optional properties shall be present" {
            val request: GetVehicleTripsRequest = createRequest(fromDate, toDate)
