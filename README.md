...
| `VEHICLE_TRIP_ENABLED`                                 | No       | `true`                 | Whether polling of vehicle trips is enabled.                                                                                                                                                             |
...
| `SKI_STATS_BASE_URL`                                   | Yes      | N/A                    | Base URL for the SkiStats API (e.g., `https://skistats.no`).                                                                                                                                                                              |
| `SKI_STATS_AUTH_PATH`                                  | Yes      | N/A                    | API path for authentication (e.g., `/api/auth`).                                                                                                                                                                                          |
| `SKI_STATS_FRIENDS_LEADERBOARDS_PATH`                  | Yes      | N/A                    | API path for fetching friends leaderboard statistics (e.g., `/api/friends/leaderboards`).                                                                                                                                                 |
| `SKI_STATS_STATISTICS_PERIODS_PATH`                    | Yes      | N/A                    | API path for fetching statistics periods for a user. Must contain the `{skiProfileId}` placeholder, which is replaced at runtime with the SkiStats user ID (UUID) from the API (e.g., `/users/{skiProfileId}/statistics/periods`).        |
| `SKI_STATS_APP_INSTANCE_ID`                            | Yes      | N/A                    | Application instance ID for SkiStats API (e.g., `a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11`).                                                                                                                                                  |
| `SKI_STATS_APP_PLATFORM`                               | Yes      | N/A                    | Application platform identifier for SkiStats API (e.g., `android`).                                                                                                                                                                       |
| `SKI_STATS_API_KEY`                                    | Yes      | N/A                    | API key for SkiStats API (e.g., `your-api-key`).                                                                                                                                                                                          |
| `SKI_STATS_APP_VERSION`                                | Yes      | N/A                    | Application version for SkiStats API (e.g., `2.3.1`).                                                                                                                                                                                     |
| `SKI_STATS_COOKIE`                                     | Yes      | N/A                    | Cookie used for authentication with SkiStats API (e.g., `ASP.NET_SessionId=...`).                                                                                                                                                         |
| `SKI_STATS_USER_AGENT`                                 | Yes      | N/A                    | User-Agent header for SkiStats API requests (e.g., `SkiStats/2.3.1 (Android)`).                                                                                                                                                           |
| `SKI_STATS_PROFILE_ISMAR_EXTERNAL_PROFILE_ID`          | Yes      | N/A                    | The SkiStats user ID (UUID) for Ismar's profile, used as path parameter in external API calls (e.g., `a0eebc99-9c0b-4ef8-bb6d-6bb9bd380a11`).                                                                                            |
| `SKI_STATS_PROFILE_ISMAR_CLIENT_ID`                    | Yes      | N/A                    | Client ID on SkiStats.                                                                                                                                                                                                                    |
| `SKI_STATS_PROFILE_ISMAR_CLIENT_SECRET`                | Yes      | N/A                    | Client secret on SkiStats (e.g., `some-client-secret`).                                                                                                                                                                                   |
| `SKI_STATS_PROFILE_ISMAR_USERNAME`                     | Yes      | N/A                    | Username for Ismar's profile on SkiStats (e.g., `ismar@example.com`).                                                                                                                                                                     |
| `SKI_STATS_PROFILE_ISMAR_PASSWORD`                     | Yes      | N/A                    | Password for Ismar's profile on SkiStats.                                                                                                                                                                                                 |
| `SKI_STATS_PROFILE_ISMAR_AGENT_ID`                     | Yes      | N/A                    | Agent ID for Ismar's profile on SkiStats (e.g., `12345`).                                                                                                                                                                                 |
| `SKI_STATS_FRIENDS_LEADERBOARD_ENABLED`                | No       | `true`                 | Whether polling of friends leaderboard ski statistics is enabled.                                                                                                                                                                         |
| `SKI_STATS_FRIENDS_LEADERBOARD_SYNC_FREQUENCY_MINUTES` | No       | 30                     | How often (in minutes) to poll the friends leaderboard API.                                                                                                                                                                               |
| `SKI_STATS_FRIENDS_LEADERBOARD_SYNC_FROM_DATE`         | Yes      | N/A                    | The date (ISO format, e.g., `2025-11-03`) from which to start syncing daily friends leaderboard data.                                                                                                                                     |
| `SKI_STATS_FRIENDS_LEADERBOARD_SYNC_FROM_WEEK_ID`      | Yes      | N/A                    | The week ID (e.g., `2901`) from which to start syncing weekly friends leaderboard data. Format: `{seasonId}{isoWeekNumber:02d}`.                                                                                                          |
| `SKI_STATS_FRIENDS_LEADERBOARD_SYNC_FROM_SEASON_ID`    | Yes      | N/A                    | The season ID (e.g., `29`) from which to start syncing seasonal friends leaderboard data.                                                                                                                                                 |
